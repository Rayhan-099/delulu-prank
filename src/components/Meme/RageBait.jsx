...
export default function RageBait() {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center relative font-sans shake-violent overflow-hidden">
            ...
            {step >= 1 && (
                ...
                >
                    <h1
                        className="text-5xl md:text-7xl font-black text-white italic glitch-text"
                        style={{ WebkitTextStroke: '2px black' }}
                        data-text="BRO STOP DAYDREAMING 💀"
                    >
            ...
            {step >= 2 && (
                ...
                >
                    <h1
                        className="text-4xl md:text-6xl font-black text-red-600 uppercase bg-yellow-300 inline-block px-4 py-2 border-4 border-black border-dashed glitch-text"
                        data-text="YOU CLICKED A RANDOM WEBSITE"
                    >
            ...
            {step >= 3 && (
                ...
                >
                    <h1
                        className="text-5xl md:text-8xl font-black text-white bg-black/80 px-4 py-2 glitch-text"
                        style={{ WebkitTextStroke: '1px red' }}
                        data-text="NOBODY CONFESSED ANYTHING"
                    >
